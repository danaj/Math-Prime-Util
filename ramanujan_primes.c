...
static const UV large_ram_upper_idx[] = {
  ...
  UVCONST(1322954129994437), /* estimate */
  UVCONST(1920283736458086), /* estimate */
  1.46*UVCONST(1920283736458086),
  2.17*UVCONST(1920283736458086),
  3.2*UVCONST(1920283736458086),
  4.8*UVCONST(1920283736458086),
  7.3*UVCONST(1920283736458086),
  11.1*UVCONST(1920283736458086),
};
...
static const UV large_ram_lower_idx[] = {
  ...
  UVCONST(1594364934427496),   /* estimate */
  1.55*UVCONST(1594364934427496), /* estimates here and further */
  2.44*UVCONST(1594364934427496),
  3.8*UVCONST(1594364934427496),
  6.2*UVCONST(1594364934427496),
  9.9*UVCONST(1594364934427496),
  16.6*UVCONST(1594364934427496),
};
