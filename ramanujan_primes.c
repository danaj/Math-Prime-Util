...
static const UV large_ram_upper_idx[] = {
  ...
  UVCONST(1302000000000000), /* estimates here and further */
  1.50*UVCONST(1302000000000000),
  2.25*UVCONST(1302000000000000),
  3.40*UVCONST(1302000000000000),
  5.10*UVCONST(1302000000000000),
  7.60*UVCONST(1302000000000000),
};
...
static const UV large_ram_lower_idx[] = {
  ...
  UVCONST(676777484008352), /* estimates here and further */
  UVCONST(1036418760000000),
  UVCONST(1604400000000000),
  1.50*UVCONST(1604400000000000),
  2.25*UVCONST(1604400000000000),
  3.37*UVCONST(1604400000000000),
  5.06*UVCONST(1604400000000000),
  7.59*UVCONST(1604400000000000),
};
