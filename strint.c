                     ...
                     const char* m, STRLEN mlen)
{
  ...
  b9_init_set_str(&M, m, mlen);
  if (b9_is_zero(&M) || b9_is_negative(&E)) {
                   ...
                   const char* b, STRLEN blen)
{
  ...
  if (b9_is_zero(&bb)) { b9_free(&ba);  b9_free(&bb);  return 0; }
                     ...
                     const char* b, STRLEN blen)
{
  ...
  if (b9_is_even(&B)) {
    ...
    if (odd_power && (b9_mod_power2(&A, 8) == 3 ||
                      b9_mod_power2(&A, 8) == 5))
      s = -s;
  }

  /* The denominator is now positive and odd. */
  if (aneg && b9_mod_power2(&B, 4) == 3) s = -s;
  ...
  while (!b9_is_zero(&A)) {
    ...
    if (odd_power && (b9_mod_power2(&B, 8) == 3 ||
                      b9_mod_power2(&B, 8) == 5))
      s = -s;
    if (b9_mod_power2(&A, 4) == 3 && b9_mod_power2(&B, 4) == 3)
      s = -s;
