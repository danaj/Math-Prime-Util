...
static const UV large_ram_upper_idx[] = {
  ...
  UVCONST(446325936284792), UVCONST(632801102617695), UVCONST(904075099006194),
  UVCONST(1301813114459680),
  /* est: 1889887693103848 */
  UVCONST(1889900000000000), /* estimates here and further */
  1.50*UVCONST(1889900000000000),
  2.25*UVCONST(1889900000000000),
  3.40*UVCONST(1889900000000000),
  5.10*UVCONST(1889900000000000),
  7.60*UVCONST(1889900000000000),
};
...
static const UV large_ram_lower_idx[] = {
  ...
  UVCONST(200433884291811), UVCONST(297735302623021), UVCONST(446616576980666),
  /* 4177, 4176, 4175,   4174, 4173, 4172,   4171, 4170, 4169 */
  UVCONST(676777499806284),
  UVCONST(1036418765854226),
  UVCONST(1604621383926489),
  1.54*UVCONST(1604621383926489), /* estimates here and further */
  2.37*UVCONST(1604621383926489),
  3.65*UVCONST(1604621383926489),
  5.62*UVCONST(1604621383926489),
  8.66*UVCONST(1604621383926489),
};
