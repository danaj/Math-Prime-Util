...
subtest 'primality around and above the 64-bit boundary' => sub {
  my @known = (
    ...
    # Proven primes selected to exercise extra-strong Lucas P=4, 9, and 15.
    ['18446744073709551629', 1],
    ['18446744073709552729', 1],
    ['18446744073709552969', 1],
    ['73786976294838218827', 1],
    # Base-2 strong pseudoprimes that reach and fail the Lucas half.
    ['318665857834031151167461', 0],
    ['6003094289670105800312596501', 0],
    ['1543267864443420616877677640751301', 0],
